...
/* $Id: string_utl.h 1071 2016-08-29 09:19:06Z hayashi $ */
...
/* string_utl.c */
typedef struct{
	int size;        /* number of string */
	int alloc_size;  /* maximum number of string */
	char **str;      /* array of string (char *) */
} STRING_ARRAY;
...
int search_string_array(int size, char **str, const char *s);
...
RC copy_file(const char fname_src[], const char fname_dest[]);
