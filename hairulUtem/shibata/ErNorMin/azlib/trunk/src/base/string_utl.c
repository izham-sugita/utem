...
/* $Id: string_utl.c 1071 2016-08-29 09:19:06Z hayashi $ */

/* [メモ]
 * STRING_ARRAY型の変数は，宣言した後でinit_string_array()で初期化してから
 * 使う． */
...
/* STRING_ARRAY stra に文字列 string を追加する．
 */
RC
...
/* STRING_ARRAY stra の中で余分に確保されているメモリを解放する．
 */
RC
...
/* str[size] の中で，文字列 s に一致するものを探し，そのインデックスを返却する．
 * 見つからない場合は -1 を返却する．
 */
int
...
/* 文字列 delim をデリミタとして文字列 string を分割し，STRING_ARRAY stra に
 * 格納する．
 */
RC
