...
/* $Id: gtk_utl.c 1066 2016-05-19 09:53:33Z hayashi $ */
...
gboolean
gtku_window_destroy (GtkWidget *widget)
{
	gtk_main_quit();
	return(FALSE);
}
...
static void
dialog_yes (GtkWidget *widget, gint *flag)
{
	*flag = FALSE;
}
...
/* ビューワーウィンドウを閉じるときにメッセージを表示する．
 */
gboolean
gtku_window_destroy_ask (GtkWidget *widget, GdkEvent *event, GtkWidget *parent)
{
...
GtkWidget *
gtku_create_gtkimage_from_xpm (GtkWidget *widget, gchar **xpm_data)
{
	GdkBitmap *mask;
...
void
create_gtk_optionmenu_item (GtkWidget *menu, GSList *group,
