...
/* $Id: nst_component.h,v 1.16 2003/07/23 04:06:31 sasaoka Exp $ */
...
RC nst_input_force(FILE *fp, FEM_BC_ARRAY *force,
...
RC nst_output_force(FILE *fp, FEM_BC_ARRAY force,
                    FEM_DEFAULT_BC_ARRAY b_force);
...
RC nst_input_eigenvector_value(FILE *fp,
                               FEM_DISP_ARRAY *evect, double value);
...
/* nst_pch_component.c */
RC read_pch_disp(FILE *fp, int subcase, int pch_sw, FEM_DISP_ARRAY *disp);
