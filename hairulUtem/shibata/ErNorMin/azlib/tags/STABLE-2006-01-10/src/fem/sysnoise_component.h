...
/* $Id: sysnoise_component.h 300 2004-06-09 11:00:54Z sasaoka $ */
...
RC sysnoise_input_pressure( FILE *fp, SOUND_PRESSURE_ARRAY *sound );
RC sysnoise_input_node( FILE *fp, NODE_ARRAY *node );
RC sysnoise_input_element( FILE *fp, ELEMENT_ARRAY *element );
RC sysnoise_output_model_file( FILE *fp, NODE_ARRAY node,
...
RC sysnoise_output_vector_mode( FILE *fp, char *name, int mode_num,
                                int damping_flag );
RC sysnoise_output_load_option( FILE *fp, BC_ARRAY force );
...
RC sysnoise_input_source_point( FILE *fp, NODE_ARRAY *node,
                                SOUND_PRESSURE_ARRAY *sound );
RC sysnoise_output_source_point( FILE *fp, NODE_ARRAY node,
...
RC sysnoise_output_boundary_velocity( FILE *fp,
                                      SOUND_PRESSURE_ARRAY sound );
RC sysnoise_input_absorbent_panels( FILE *fp, SOUND_PRESSURE_ARRAY *sound );
RC sysnoise_output_absorbent_panels( FILE *fp, SOUND_PRESSURE_ARRAY sound );
RC sysnoise_input_symmetry_plane( FILE *fp, VECT3D *p, int *counter );
RC sysnoise_output_symmetry_plane( FILE *fp, VECT3D p, int counter );
