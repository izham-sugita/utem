...
/* $Id: gtk_utl.c 864 2007-01-17 10:02:04Z sasaoka $ */
...
gboolean
gtku_window_destory (GtkWidget *widget)
{
	gtk_main_quit();
	return(FALSE);
}
...
gboolean
gtku_window_destory_ask (GtkWidget *widget, GdkEvent *event, GtkWidget *parent)
{
