...
/* $Id: math_utl.h 931 2009-12-14 05:32:09Z aoyama $ */
...
RC inner_product_scalar1r_complex(int n, const double a1[],
		const COMPLEX b[], int nz_begin, int nz_end, COMPLEX *a1b);
...
RC inner_product_scalar6r_complex(int n, const double a1[], const double a2[],
		...
		const COMPLEX b[], int nz_begin, int nz_end,
		COMPLEX *a1b, COMPLEX *a2b, COMPLEX *a3b, COMPLEX *a4b,
		COMPLEX *a5b, COMPLEX *a6b);
