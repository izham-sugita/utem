...
/* $Id: nst_component.h 999 2012-01-29 06:38:00Z aoyama $ */
...
RC nst_input_heatflux(FILE *fp, BC_ARRAY *flux);
RC nst_input_heattransfer(FILE *fp, ELEMENT_ARRAY surf,
                          ELEMENT_ARRAY *transfer);
