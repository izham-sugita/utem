...
/* $Id: avs_utl.c 1023 2012-06-23 09:19:55Z tago $ */
...
/* FILE *fopen_avs_step_data() 専用 */
RC
output_avs_step_bc_temp (FILE *fp_avs, NODE_ARRAY node, BC_ARRAY temp,
                         double def_temp)
{
	int step_num;
	...
	RC_TRY( avs_printbc_temp(fp_avs, temp, def_temp, node) );
